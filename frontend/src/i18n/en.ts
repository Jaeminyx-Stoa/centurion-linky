...
const en: Record<TranslationKey, string> = {
  ...
  // Analytics - Revenue
  "analytics.tab.revenue": "Revenue",
  "analytics.revenue.title": "Revenue & Margin Analysis",
  "analytics.revenue.procedureProfit": "Procedure Profitability",
  "analytics.revenue.procedureName": "Procedure",
  "analytics.revenue.cases": "Cases",
  "analytics.revenue.totalRevenue": "Total Revenue",
  "analytics.revenue.materialCost": "Material Cost",
  "analytics.revenue.grossMargin": "Gross Margin",
  "analytics.revenue.marginRate": "Margin Rate",
  "analytics.revenue.clv": "Customer Lifetime Value",
  "analytics.revenue.customerName": "Customer",
  "analytics.revenue.totalPayments": "Total Payments",
  "analytics.revenue.visitCount": " visits",
  "analytics.revenue.avgTicket": "Avg Ticket",
  "analytics.revenue.predictedAnnual": "Est. Annual",
  "analytics.revenue.nationalityAvg": "Avg CLV by Nationality",
  "analytics.revenue.heatmap": "Revenue Heatmap",
  "analytics.revenue.peakSlots": "Peak Time Slots",
  "analytics.revenue.dayOfWeek": "Day",
  "analytics.revenue.hour": "Hour",
  "analytics.revenue.amount": "Amount",

  // Followups
  "followups.title": "Post-Procedure Care",
  "followups.rules": "Followup Rules",
  "followups.empty": "No followup rules registered",
  "followups.create": "Add Rule",
  "followups.eventType": "Event Type",
  "followups.delayDays": "days",
  "followups.delayHours": "hours",
  "followups.messageTemplate": "Message Template",
  "followups.procedure": "Linked Procedure",
  "followups.global": "Global",
  "followups.keywords": "Side Effect Keywords",
  "followups.keywordsSeverity": "Severity",
  "followups.alerts": "Side Effect Alerts",
  "followups.type.recoveryCheck": "Recovery Check",
  "followups.type.sideEffectCheck": "Side Effect Check",
  "followups.type.resultCheck": "Result Check",
  "followups.type.retouchReminder": "Retouch Reminder",
  "followups.severity.urgent": "Urgent",
  "followups.severity.normal": "Normal",
  ...
  "documents.chartDraft": "Chart Draft",
  "documents.consentForm": "Consent Form",
  "documents.chiefComplaint": "Chief Complaint",
  "documents.desiredProcedures": "Desired Procedures",
  "documents.medicalHistory": "Medical History",
  "documents.skinType": "Skin Type",
  "documents.aiRecommendations": "AI Recommendations",
  "documents.risks": "Risks",
  "documents.alternatives": "Alternatives",
  "documents.expectedResults": "Expected Results",
  "documents.aftercareInstructions": "Aftercare Instructions",
  "documents.patientAcknowledgements": "Patient Acknowledgements",
  "documents.status.draft": "Draft",
  "documents.status.reviewed": "Reviewed",
  "documents.status.signed": "Signed",
  "documents.status.archived": "Archived",
  "documents.generateChartDraft": "Generate Chart Draft",
  "documents.generateConsentForm": "Generate Consent Form",
